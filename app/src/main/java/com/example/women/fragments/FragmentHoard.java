...
import com.example.women.activities.ReportActivityHoard;
import com.example.women.adaptrs.HoardRecyclerViewAdapter;
...
public class FragmentHoard extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), ReportActivityHoard.class);
    ...
    private void initComponent(){
        ...
        Call<List<ClassGetReport>> call = apiInterface.getDataHoard();
        call.enqueue(new Callback<List<ClassGetReport>>() {
            ...
            public void onResponse(Call<List<ClassGetReport>> call, Response<List<ClassGetReport>> response) {
                ...
                mAdapter = new HoardRecyclerViewAdapter(get_data_class,getContext());
