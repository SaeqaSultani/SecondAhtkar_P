...
public class PlaceRecyclerViewAdapter extends RecyclerView.Adapter<PlaceRecyclerViewAdapter.ViewHolder> {
    ...
    public PlaceRecyclerViewAdapter(List<ClassGetReport> classGetReports, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder,final int position) {
        ...
        holder.title.setText(classGetReports.get(position).getEhtakarPositionName());
